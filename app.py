...
.vale-nav {display: flex; align-items: center; gap: 10px; text-align: cetnre; justify-content: space-between;}
...
st.markdown(
    "<div class='vale-nav'>"
    "<div style='display:flex; position: absolute; top: 0px; gap:10px; justify-content: center;'>"
